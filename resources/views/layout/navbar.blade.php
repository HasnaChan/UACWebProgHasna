@if (!in_array(request()->route()->getName(), ['login', 'register']))
    <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand text-warning" href="#">Job Friends</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-center"> <!-- Add justify-content-center class here -->
                    <li class="nav-item">
                        ...
                        <div class="d-flex col">
                            <div>
                                <a class="nav-link {{ request()->route()->getName() === 'home' ? 'text-warning' : 'text-light' }} {{ request()->route()->getName() === 'home' ? 'active' : '' }}" aria-current="page" href="/home">Home</a>
                            </div>
                        </div>
                        @else
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="#" class="btn btn-warning me-3" onclick="confirmLogout()">Logout</a>
